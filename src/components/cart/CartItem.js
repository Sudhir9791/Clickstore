        ...
        <>
            <div className="cart_item">
                <figure className="cart_item_img">
                    <Link to={`${path}${id}`}>
                        <img src={images[0]} alt="product-img" width="200" height="200"/>
                    </Link>
                </figure>
                <div className="cart_item_info">
                    <div className="cart_item_head">
                        <h4 className="cart_item_title">
                            <Link to={`/product-details/${id}`} style={{textDecoration: 'none'}}>
                                <div className='checkout_title'>{title}</div> </Link>
                                <div className='checkout_info'>{info}</div>
                        </h4>
                    ...
                    <h2 className="item_price">
                        <div className='cart_item_price'>{newPrice} &nbsp;</div>
